...
namespace ProiectColectiv.Data.Migrations
{
    ...
    [Migration("20181108201026_MockDataAndJobsProperties")]
    partial class MockDataAndJobsProperties
    {
            ...
            modelBuilder.Entity("ProiectColectiv.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AvailableUntil = new DateTime(2020, 12, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), Description = "Se doreste un astronaut part-time.Program flexibil si cina inclusa(cereale dezhidratate)", PostedOn = new DateTime(2018, 11, 8, 22, 10, 26, 580, DateTimeKind.Local), Title = "Astronaut" },
                        new { Id = 2, AvailableUntil = new DateTime(2020, 12, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), Description = "Se doreste un pitic pentru eschibitii pe Piezisa. Program flexibil si bere inclusa(de la Infinity)", PostedOn = new DateTime(2018, 11, 8, 22, 10, 26, 580, DateTimeKind.Local), Title = "Pitic" },
                        new { Id = 3, AvailableUntil = new DateTime(2020, 12, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), Description = "Program flexibil si masa inclusa(skittles)", PostedOn = new DateTime(2018, 11, 8, 22, 10, 26, 580, DateTimeKind.Local), Title = "Crescatpr de unicorni" }
                    );
                });
